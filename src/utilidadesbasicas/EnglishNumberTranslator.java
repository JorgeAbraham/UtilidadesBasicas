...
public class EnglishNumberTranslator {
    ...
    public static String convert(double numeroDoble){
        
        
        DecimalFormat formateador = new DecimalFormat("###,##0.00");
        return convert(formateador.format (numeroDoble));
    ...
    public static void main(String args[]){
        ...
        try {
            System.out.println(EnglishNumberTranslator.convert(156443.10));
